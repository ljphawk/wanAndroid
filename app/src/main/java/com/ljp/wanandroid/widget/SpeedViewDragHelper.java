 ...
 */
public class SpeedViewDragHelper {
     ...
     */
    public static SpeedViewDragHelper create(@NonNull ViewGroup forParent, @NonNull Callback cb) {
        return new SpeedViewDragHelper(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static SpeedViewDragHelper create(@NonNull ViewGroup forParent, float sensitivity,
                                             @NonNull Callback cb) {
        final SpeedViewDragHelper helper = create(forParent, cb);
     ...
     * @param forParent Parent view to monitor
     */
    private SpeedViewDragHelper(@NonNull Context context, @NonNull ViewGroup forParent,
                                @NonNull Callback cb) {
        if (forParent == null) {
