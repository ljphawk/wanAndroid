...
import com.ljp.lib_base.app.UtilsApplicationDelegate;
 ...
 * </pre>
 * <p>
 * https://www.jianshu.com/p/509b0d2626f4?tdsourcetag=s_pctim_aiomsg
 * https://github.com/Blankj/AndroidUtilCode/blob/master/lib/utilcode/src/main/java/com/blankj/utilcode/util/SpanUtils.java
 * https://github.com/Blankj/AndroidUtilCode/blob/master/feature/utilcode/pkg/src/main/java/com/blankj/utilcode/pkg/feature/span/SpanActivity.kt
 */
public final class SpanUtils {
    ...
    public SpanUtils setBold(boolean isBold) {
        this.isBold = isBold;
        return this;
    }
...
//            LogUtils.e(fm, sfm);
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(UtilsApplicationDelegate.instance.getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            UtilsApplicationDelegate.instance.getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(UtilsApplicationDelegate.instance.getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(UtilsApplicationDelegate.instance, mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
